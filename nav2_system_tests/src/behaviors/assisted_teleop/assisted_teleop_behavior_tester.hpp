...
private:
  ...
  void amclPoseCallback(const geometry_msgs::msg::PoseWithCovarianceStamped::ConstSharedPtr &);

  void filteredVelCallback(const geometry_msgs::msg::TwistStamped::ConstSharedPtr & msg);
