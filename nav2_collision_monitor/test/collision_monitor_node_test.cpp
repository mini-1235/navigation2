...
protected:
  void cmdVelOutCallback(const geometry_msgs::msg::Twist::ConstSharedPtr & msg);
  void actionStateCallback(const nav2_msgs::msg::CollisionMonitorState::ConstSharedPtr & msg);
...
void Tester::cmdVelOutCallback(const geometry_msgs::msg::Twist::ConstSharedPtr & msg)
{
  cmd_vel_out_ = msg;
}

void Tester::actionStateCallback(const nav2_msgs::msg::CollisionMonitorState::ConstSharedPtr & msg)
{
  action_state_ = msg;
}
